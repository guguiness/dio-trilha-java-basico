...
public class ExercicioProposto03 {
    ...
    public static void main(String[] args) {
        ...
        Set<Map.Entry<Integer, Contato>> set = new TreeSet<>(Comparator.comparing(entry -> entry.getValue().getNumero()));
       ...
       /* Set<Map.Entry<Integer, Contato>> set1 = new TreeSet<>(new Comparator<Map.Entry<Integer, Contato>>() {
        ...
        /*Set<Map.Entry<Integer, Contato>> set1 = new TreeSet<>(Comparator.comparing(new Function<Map.Entry<Integer,
                Contato>, String>() {
            @Override
